...
export const Profile = ({ name, role, image, isLoading }) => {
  return (
    <div
      ...
      } p-0 bg-gradient-to-r from-sky-500 to-indigo-500 rounded-2xl mb-5 dark:from-sky-700 dark:to-indigo-700`}
    >
      <div className="pb-3">
          ...
          <div className="relative mt-8 ml-20">
            <svg height="250" width="250" className="relative">
              ...
              <Circle
                size="lg"
                hasStroke
                className="stroke-cyan-500 w-full h-full fill-none dark:stroke-cyan-300"
        ...
        <div className="profile bg-neutral-100 -mt-24 mx-1 -mb-2 rounded-2xl dark:bg-neutral-950">
          <div className="flex flex-col items-end justify-center pt-8 pr-20 mb-14 gap-3">
            {isLoading ? (
              ...
              <>
                <h1 className="font-dancing_script text-9xl dark:text-white">
                  {name}
                </h1>
