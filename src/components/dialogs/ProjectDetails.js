...
import { getProjectSector, getProjectType, timestampToDate } from '../../helper/GlobalService';
  ...
  return (
    <div className='flex flex-col gap-7'>
      <section>
        ...
        <p className='text-neutral-500'>{timestampToDate(data?.startDate)} - <span>{data.endDate ? timestampToDate(data.endDate) : 'Present'}</span></p>
      </section>
      <section>
